...
class CoberturasTest extends PHPUnit_Framework_TestCase
{
	...
	public function setUp()
	{
		...
		$this->responsabilidades = new Coleccion();
		$this->responsabilidades->add(new ResponsabilidadCobertura(new CoberturaConcepto('R.C. Daños a Terceros'), 'HASTA 1, 500 D.S.M.V.G.D.F.'));
		$this->responsabilidades->add(new ResponsabilidadCobertura(new CoberturaConcepto('Asesoría Jurídica'), 'HASTA 1, 500 D.S.M.V.G.D.F.'));
		$this->responsabilidades->add(new ResponsabilidadCobertura(new CoberturaConcepto('Daños Materiales'), 'HASTA 1, 500 D.S.M.V.G.D.F.'));
	}

	public function testSePuedeAgregarResponsabilidadDaniosMaterialesACoberturaLocal()
	{
		$cobertura = new Cobertura('Local default', new CoberturaTipo(CoberturaTipo::LOCAL), new Servicio(Servicio::FEDERAL), $this->responsabilidades);
	...
	{
		$cobertura = new Cobertura('Básica default', new CoberturaTipo(CoberturaTipo::BASICA), new Servicio(Servicio::FEDERAL), $this->responsabilidades);
	...
	{
		$cobertura = new Cobertura('Amplia default', new CoberturaTipo(CoberturaTipo::AMPLIA), new Servicio(Servicio::FEDERAL), $this->responsabilidades);
