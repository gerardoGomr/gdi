    ...
    <div class="row row-app margin-none">
        <div class="col-md-12 col-lg-9">
            <div class="col-separator col-separator-first border-none">
                <div class="col-table">
                    <h4 class="innerAll">PAGO DE PÓLIZA DIFERENCIA</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-5">
                                            <div class="box-generic padding-none">
                                                ...
                                                <dl class="dl-horizontal">
                                                    ...
                                                    <dt>COSTO TOTAL:</dt>
                                                    <dd>{{ $poliza->getCosto()->costoFormateado() }} - DIFERENCIA: ${{ number_format($poliza->getCostoDiferencia(), 2) }}</dd>
                                                    <dt>VIGENCIA:</dt>
                                        ...
                                        <div class="col-md-7">
                                            <div class="box-generic padding-none">
                                                ...
                                                <p class="strong innerAll text-medium">Total a pagar:<span class="text-primary">${{ number_format($poliza->getCostoDiferencia(), 2) }}</span>
                                                </p>
                                                <form action="{{ url('polizas/pagar/diferencia') }}" class="form-horizontal" role="form" id="formPago">
                                                    {!! csrf_field() !!}
                                                    ...
                                                    <div class="text-center border-top innerTB">
                                                        <input type="hidden" id="costo" value="{{ $poliza->getCostoDiferencia() }}">
...
@section('js')
    <script src="{{ asset('js/polizas/polizas_pagar_diferencia.js') }}"></script>
@stop