...
elixir(function(mix) {
	mix.less('admin/admin.less')
		.scripts([
			...
			'components/core/js/tokenAjaxSetup.js',
		...
		.styles([
			...
			'components/common/forms/validator/assets/lib/jquery-validation/css/core.css',
			'components/common/forms/validator/assets/lib/jquery-validation/css/reset.css',
			'components/common/forms/validator/assets/lib/jquery-validation/css/cmxform.css',
			'components/common/forms/validator/assets/lib/jquery-validation/css/cmxformTemplate.css',
