...
namespace DoctrineProxies\__CG__\GDI\Dominio\Usuarios;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Usuario extends \GDI\Dominio\Usuarios\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'username', 'passwd', 'activo', 'usuarioTipo', 'oficina', 'nombre', 'paterno', 'materno', 'sexo', 'telefono', 'celular', 'email'];
        }
