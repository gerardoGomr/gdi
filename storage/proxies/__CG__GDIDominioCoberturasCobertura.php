 ...
 */
class Cobertura extends \GDI\Dominio\Coberturas\Cobertura implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GDI\\Dominio\\Coberturas\\Cobertura' . "\0" . 'id', '' . "\0" . 'GDI\\Dominio\\Coberturas\\Cobertura' . "\0" . 'nombre', '' . "\0" . 'GDI\\Dominio\\Coberturas\\Cobertura' . "\0" . 'coberturaTipo', '' . "\0" . 'GDI\\Dominio\\Coberturas\\Cobertura' . "\0" . 'servicio', '' . "\0" . 'GDI\\Dominio\\Coberturas\\Cobertura' . "\0" . 'oficina', '' . "\0" . 'GDI\\Dominio\\Coberturas\\Cobertura' . "\0" . 'costos', '' . "\0" . 'GDI\\Dominio\\Coberturas\\Cobertura' . "\0" . 'responsabilidades'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cobertura $proxy) {
    ...
    public function getCoberturaTipo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCoberturaTipo', []);

        return parent::getCoberturaTipo();
    }
    ...
    public function verificarResponsabilidad()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'verificarResponsabilidad', []);
