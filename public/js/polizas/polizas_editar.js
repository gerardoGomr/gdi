$(document).ready(function() {
	...
	$datoAsociadoBuscar.on('keyup', function (event) {
		...
		if (event === 13 || event.which === 13) {
			$.ajax({
				...
				dataType:   'json',
				data:       {
					datoAsociado: $datoAsociadoBuscar.val(),
	...
	$('#coberturaTipo').on('change', function () {
		...
		if ($(this).val() !== '' && $('#servicio').val() !== '') {
			$.ajax({
				...
				dataType:   'json',
				data:       {
					coberturaTipoId: $('#coberturaTipo').val(),
	...
	$('#cobertura').on('change', function (event) {
		...
		if ($(this).val() === '-1') {
			...
			$('#registroVigencias').removeClass('hide');
			$('#registroResponsabilidades').removeClass('hide');
			...
			$('#registroVigencias').addClass('hide');
			$('#registroResponsabilidades').addClass('hide');
	...
	$('#vigenciaCobertura').on('change', function (event) {
